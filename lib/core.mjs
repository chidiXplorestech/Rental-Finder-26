...
export function normalizeSearchResult(raw, filters={}) {
  ...
  return {
    ...
    rentPcm, bedrooms, floorAreaSqft, postcode, postcodeDistrict, location, propertyType:pType,
...
export function validateFilters(input={}) {
  ...
  return {location,minBedrooms,maxBedrooms,maxRent,minSqft,maxAgeDays,preferredType,acceptHouses,keywords,excludeStudents,preferredAreas,priorityDistricts};
}
