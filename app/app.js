...
function setLoading(loading,label="Searching inventory…"){ $("loadingState").hidden=!loading;$("searchButton").disabled=loading;$("refreshButton").disabled=loading;$("searchButton").querySelector("span").textContent=loading?label:"Find matching rentals";if(loading){$("errorState").hidden=true;$("partialNotice").hidden=true;} }
